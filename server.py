...
def generate_coverage():
    ...
    raw_cov = call_claude(
        ...
        f"""Write coverage for this {script_type} based on the master summary below.
...
- "logline": a compelling one or two sentence logline
- "email_response": Using the summary provided, identify what made this script feel unique and what it did well — be specific and pull only from what's actually on the page. Assess how it might be relevant for today's marketplace. Include one or two comp titles and explain why they apply. {comp_note}
- "summary": the full master summary in clean polished prose, present tense, covering all major beats from start to finish
